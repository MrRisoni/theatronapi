...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 01, 2019 at 10:02 AM
...
CREATE TABLE `seatfloor` (
  ...
  `scr_theater_id` int(10) UNSIGNED NOT NULL DEFAULT '1',
...
--
ALTER TABLE `seatfloor`
  MODIFY `scr_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15748;
